...
import styles from "./subfolders_tracking.module.scss";
...
const SubfoldersTracking: React.FC = () => {
  const trackingPoints = [
    "Analyze traffic to blogs, product pages, and support sections",
    "Identify subdomains tied to key business functions",
    "Track which sections are gaining or losing traction",
  ];

  const features: Feature[] = [
    {
      icon: <FolderOutlined className={styles.featureIcon} />,
      title: "Subfolder Analysis",
      description:
        "Deep dive into traffic patterns across different website sections and content categories.",
    },
    {
      icon: <BarChartOutlined className={styles.featureIcon} />,
      title: "Section Performance",
      description:
        "Compare traffic performance between blogs, product pages, support sections, and more.",
    },
    {
      icon: <GlobalOutlined className={styles.featureIcon} />,
      title: "Subdomain Insights",
      description:
        "Analyze subdomain traffic patterns and identify key business function performance.",
    },
    {
      icon: <BranchesOutlined className={styles.featureIcon} />,
      title: "Site Structure Mapping",
      description:
        "Understand competitor site architecture and how content is organized for maximum impact.",
    },
    {
      icon: <RiseOutlined className={styles.featureIcon} />,
      title: "Growth Tracking",
      description:
        "Monitor which sections are gaining or losing traction over time to spot trends.",
    },
    {
      icon: <SearchOutlined className={styles.featureIcon} />,
      title: "Content Strategy Insights",
      description:
        "Reveal conversion strategies and content approaches across different site sections.",
    },
  ];
        ...
        <div className={styles.content}>
          <div className={styles.leftSection}>
            <h2 className={styles.title}>
              Uncover the site sections driving competitor growth
            </h2>
          ...
          <div className={styles.rightSection}>
            <div className={styles.dashboardPreview}>
              ...
              <div className={styles.subfoldersTable}>
                <div className={styles.tableHeader}>
                  <span className={styles.subfolderColumn}>Subfolder</span>
                ...
                <div className={styles.subfolderRow}>
                  <span className={styles.subfolderName}>/store/</span>
                ...
                <div className={styles.subfolderRow}>
                  <span className={styles.subfolderName}>/gp/video</span>
                  <div className={styles.trafficBar}>
                    <div
                      className={styles.trafficProgress}
                      style={{ width: "43%" }}
                ...
                <div className={styles.subfolderRow}>
                  <span className={styles.subfolderName}>/gp/your-account</span>
                  <div className={styles.trafficBar}>
                    <div
                      className={styles.trafficProgress}
                      style={{ width: "35%" }}
                ...
                <div className={styles.subfolderRow}>
                  <span className={styles.subfolderName}>/gp/product</span>
                  <div className={styles.trafficBar}>
                    <div
                      className={styles.trafficProgress}
                      style={{ width: "33%" }}
                    ></div>
                    <span className={styles.trafficPercent}>33%</span>
                  </div>
                  <div className={styles.trendChart}>
                    <svg viewBox="0 0 40 20" className={styles.miniChart}>
                      <polyline
                ...
                <div className={styles.subfolderRow}>
                  <span className={styles.subfolderName}>/gp/signin</span>
                  <div className={styles.trafficBar}>
                    <div
                      className={styles.trafficProgress}
                      style={{ width: "27%" }}
                  ...
                  <div className={styles.trendChart}>
                    <svg viewBox="0 0 40 20" className={styles.miniChart}>
                      <polyline
                        points="2,18 8,15 14,13 20,10 26,12 32,9 38,7"
                        fill="none"
                        stroke="#13c2c2"
                        strokeWidth="2"
                      />
...
export default SubfoldersTracking;
